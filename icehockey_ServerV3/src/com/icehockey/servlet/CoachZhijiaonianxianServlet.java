...
/**
 * Servlet implementation class CoachZhijiaonianxianServlet
 */
@WebServlet("/CoachZhijiaonianxianServlet.do")
public class CoachZhijiaonianxianServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CoachZhijiaonianxianServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("CoachZhijiaonianxian:userId :" + userId);
