...
/**
 * Servlet implementation class JudgeDegreeServlet
 */
@WebServlet("/JudgeDegreeServlet.do")
public class JudgeDegreeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public JudgeDegreeServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("JudgeDegreeInfo:userId :" + userId);
