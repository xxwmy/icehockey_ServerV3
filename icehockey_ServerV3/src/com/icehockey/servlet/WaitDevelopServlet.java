...
/**
 * Servlet implementation class WaitDevelopServlet
 */
@WebServlet("/WaitDevelopServlet.do")
public class WaitDevelopServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WaitDevelopServlet() {
        super();
