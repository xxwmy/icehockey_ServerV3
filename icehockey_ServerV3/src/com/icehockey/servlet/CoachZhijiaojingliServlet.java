...
/**
 * Servlet implementation class CoachZhijiaojingliServlet
 */
@WebServlet("/CoachZhijiaojingliServlet.do")
public class CoachZhijiaojingliServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CoachZhijiaojingliServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("CoachZhijiaojingli:userId :" + userId);
