...
/**
 * Servlet implementation class CoachHonorServlet
 */
@WebServlet("/CoachHonorServlet.do")
public class CoachHonorServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CoachHonorServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("CoachHonor:userId :" + userId);
