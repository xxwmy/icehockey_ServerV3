...
/**
 * Servlet implementation class CoachDegreeServlet
 */
@WebServlet("/CoachDegreeServlet.do")
public class CoachDegreeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CoachDegreeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("CoachDegreeInfo:userId :"+userId);
