...
/**
 * Servlet implementation class JudgeExpServlet
 */
@WebServlet("/JudgeExpServlet.do")
public class JudgeExpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JudgeExpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("JudgeExpInfo:userId :" + userId);
