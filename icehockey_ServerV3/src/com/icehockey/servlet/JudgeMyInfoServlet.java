...
/**
 * Servlet implementation class JudgeMyInfoServlet
 */
@WebServlet("/JudgeMyInfoServlet.do")
public class JudgeMyInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public JudgeMyInfoServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("JudgeMyInfo:userId :" + userId);
