...
/**
 * Servlet implementation class JudgeMyActServlet
 */
@WebServlet("/JudgeMyActServlet.do")
public class JudgeMyActServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public JudgeMyActServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("JudgeMyActInfo:userId :" + userId);
