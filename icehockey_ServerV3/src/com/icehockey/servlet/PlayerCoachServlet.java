...
/**
 * Servlet implementation class PlayerCoachServlet
 */
@WebServlet("/PlayerCoachServlet.do")
public class PlayerCoachServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PlayerCoachServlet() {
        super();
